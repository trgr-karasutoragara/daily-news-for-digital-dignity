...
def get_all_news():
	...
	print(f"📊 ニュース取得完了: 国内{len(all_news['japanese'])}件、国際{len(all_news['international'])}件")
...
<body>
	...
	html += f"""
			...
			<div class="note success">
				✅ BBC・Guardian・Deutsche Welle・地域メディアから{len(news['international'])}件を自動取得・翻訳
			</div>"""
...
def main():
	...
	if success:
		...
		print("   1. 2段階認証を有効化")
		print("   2. アプリパスワードを生成")
		print("   3. SENDER_PASSWORDに16文字のアプリパスワードを設定")
